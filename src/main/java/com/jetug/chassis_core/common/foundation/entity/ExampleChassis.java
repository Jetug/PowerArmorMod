...
//    };
    ...
    public ExampleChassis(EntityType<? extends ArmorChassisBase> type, Level worldIn) {
        super(type, worldIn);
    }
...
//                return new ChassisMenu(id, inventory, menu, ExampleChassis.this);
//            }
//
//            @Override
...
//            @Override
//            public AbstractContainerMenu createMenu(int id, Inventory menu, Player player) {
//                return new ArmorStationMenu(id, inventory, menu, ExampleChassis.this);
//            }
//
//            @Override
//            public Component getDisplayName() {
...
//        return true; //getEquipment(BODY_FRAME).getItem() == ItemRegistry.FIREPROOF_COATING.get();
//    }
//
