...
public class HitboxTestRenderer <Type extends LivingEntity> extends LivingRenderer<Type, TestModel<Type>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(PowerArmorMod.MOD_ID, "textures/entities/test_model.png");

    public HitboxTestRenderer(EntityRendererManager context) {
